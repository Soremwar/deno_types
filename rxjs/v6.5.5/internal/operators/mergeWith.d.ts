...
/** @deprecated use {@link mergeWith} */
export declare function merge<T, T2>(
  v2: ObservableInput<T2>,
): OperatorFunction<T, T | T2>;
/** @deprecated use {@link mergeWith} */
export declare function merge<T, T2, T3>(
  v2: ObservableInput<T2>,
  v3: ObservableInput<T3>,
): OperatorFunction<T, T | T2 | T3>;
/** @deprecated use {@link mergeWith} */
export declare function merge<T, T2, T3, T4>(
  v2: ObservableInput<T2>,
  v3: ObservableInput<T3>,
  v4: ObservableInput<T4>,
): OperatorFunction<T, T | T2 | T3 | T4>;
/** @deprecated use {@link mergeWith} */
export declare function merge<T, T2, T3, T4, T5>(
  v2: ObservableInput<T2>,
  v3: ObservableInput<T3>,
  v4: ObservableInput<T4>,
...
/** @deprecated use {@link mergeWith} */
export declare function merge<T, T2, T3, T4, T5, T6>(
  v2: ObservableInput<T2>,
  v3: ObservableInput<T3>,
  v4: ObservableInput<T4>,
  v5: ObservableInput<T5>,
