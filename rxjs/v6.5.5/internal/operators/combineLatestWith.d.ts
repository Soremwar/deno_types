...
/** @deprecated use {@link combineLatestWith} */
export declare function combineLatest<T, T2, R>(
  v2: ObservableInput<T2>,
  project: (v1: T, v2: T2) => R,
): OperatorFunction<T, R>;
/** @deprecated use {@link combineLatestWith} */
export declare function combineLatest<T, T2, T3, R>(
  v2: ObservableInput<T2>,
  v3: ObservableInput<T3>,
  project: (v1: T, v2: T2, v3: T3) => R,
): OperatorFunction<T, R>;
/** @deprecated use {@link combineLatestWith} */
export declare function combineLatest<T, T2, T3, T4, R>(
  v2: ObservableInput<T2>,
  v3: ObservableInput<T3>,
...
/** @deprecated use {@link combineLatestWith} */
export declare function combineLatest<T, T2, T3, T4, T5, R>(
  v2: ObservableInput<T2>,
  v3: ObservableInput<T3>,
  v4: ObservableInput<T4>,
...
/** @deprecated use {@link combineLatestWith} */
export declare function combineLatest<T, T2, T3, T4, T5, T6, R>(
  v2: ObservableInput<T2>,
  v3: ObservableInput<T3>,
  v4: ObservableInput<T4>,
  v5: ObservableInput<T5>,
...
/** @deprecated use {@link combineLatestWith} */
export declare function combineLatest<T, T2>(
  v2: ObservableInput<T2>,
): OperatorFunction<T, [T, T2]>;
/** @deprecated use {@link combineLatestWith} */
export declare function combineLatest<T, T2, T3>(
  v2: ObservableInput<T2>,
  v3: ObservableInput<T3>,
): OperatorFunction<T, [T, T2, T3]>;
/** @deprecated use {@link combineLatestWith} */
export declare function combineLatest<T, T2, T3, T4>(
  v2: ObservableInput<T2>,
  v3: ObservableInput<T3>,
  v4: ObservableInput<T4>,
): OperatorFunction<T, [T, T2, T3, T4]>;
/** @deprecated use {@link combineLatestWith} */
export declare function combineLatest<T, T2, T3, T4, T5>(
  v2: ObservableInput<T2>,
  v3: ObservableInput<T3>,
  v4: ObservableInput<T4>,
  v5: ObservableInput<T5>,
...
/** @deprecated use {@link combineLatestWith} */
export declare function combineLatest<T, T2, T3, T4, T5, T6>(
  v2: ObservableInput<T2>,
  v3: ObservableInput<T3>,
  v4: ObservableInput<T4>,
  v5: ObservableInput<T5>,
...
/** @deprecated use {@link combineLatestWith} */
export declare function combineLatest<T, TOther, R>(
 ...
 */
export declare function combineLatestWith<T, A extends ObservableInput<any>[]>(
  ...otherSources: A
