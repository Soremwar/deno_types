import { Observer, PartialObserver } from './types.d.ts';
...
export declare class SafeSubscriber<T> extends Subscriber<T> {
    ...
    private _context;
    constructor(_parentSubscriber: Subscriber<T>, observerOrNext?: PartialObserver<T> | ((value: T) => void) | null, error?: ((e?: any) => void) | null, complete?: (() => void) | null);
    next(value?: T): void;
    error(err?: any): void;
    complete(): void;
