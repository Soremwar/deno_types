 ...
 */
export declare type ObservedValueOf<O> = O extends ObservableInput<infer T> ? T
  : never;
/**
 ...
 */
export declare type ObservedValueUnionFromArray<X> = X extends
  Array<ObservableInput<infer T>> ? T : never;
 ...
 * of `[string, number]`.
 */
export declare type ObservedValueTupleFromArray<X> = X extends
 ...
 */
export declare type Cons<X, Y extends any[]> =
  ((arg: X, ...rest: Y) => any) extends ((...args: infer U) => any) ? U : never;
/**
 * Extracts the head of a tuple.
 * If you declare `Head<[A, B, C]>` you will get back `A`.
 */
export declare type Head<X extends any[]> = ((...args: X) => any) extends
  ((arg: infer U, ...rest: any[]) => any) ? U : never;
/**
 * Extracts the tail of a tuple.
 * If you declare `Tail<[A, B, C]>` you will get back `[B, C]`.
 */
export declare type Tail<X extends any[]> = ((...args: X) => any) extends
  ((arg: any, ...rest: infer U) => any) ? U : never;
/**
