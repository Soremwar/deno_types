...
export declare function combineLatest<O1 extends ObservableInput<any>, R>(
  sources: [O1],
...
/** @deprecated resultSelector no longer supported, pipe to map instead */
export declare function combineLatest<O extends ObservableInput<any>, R>(
  sources: O[],
...
export declare function combineLatest<O1 extends ObservableInput<any>>(
  sources: [O1],
  scheduler: SchedulerLike,
...
>;
/** @deprecated Passing a scheduler here is deprecated, use {@link subscribeOn} and/or {@link observeOn} instead */
export declare function combineLatest<O extends ObservableInput<any>>(
  sources: O[],
  scheduler: SchedulerLike,
...
/** @deprecated Passing a scheduler here is deprecated, use {@link subscribeOn} and/or {@link observeOn} instead */
export declare function combineLatest<R>(
  ...observables: Array<
...
export declare class CombineLatestOperator<T, R> implements Operator<T, R> {
  ...
  constructor(resultSelector?: ((...values: Array<any>) => R) | undefined);
 ...
 * @extends {Ignored}
 */
export declare class CombineLatestSubscriber<T, R>
  ...
  constructor(
    ...
    resultSelector?: ((...values: Array<any>) => R) | undefined,
  );
