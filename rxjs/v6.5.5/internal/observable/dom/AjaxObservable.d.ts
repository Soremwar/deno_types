...
export declare function ajaxGet(
  url: string,
  headers?: object,
): AjaxObservable<AjaxResponse>;
export declare function ajaxPost(
  url: string,
  body?: any,
  headers?: Object,
): Observable<AjaxResponse>;
export declare function ajaxDelete(
  url: string,
  headers?: Object,
): Observable<AjaxResponse>;
export declare function ajaxPut(
  url: string,
  body?: any,
  headers?: Object,
): Observable<AjaxResponse>;
export declare function ajaxPatch(
  url: string,
  body?: any,
  headers?: Object,
): Observable<AjaxResponse>;
export declare function ajaxGetJSON<T>(
  url: string,
  headers?: Object,
): Observable<T>;
/**
