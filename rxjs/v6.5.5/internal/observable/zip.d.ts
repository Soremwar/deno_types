...
import { ObservableInput, ObservedValueOf } from "../types.d.ts";
import { Subscriber } from "../Subscriber.d.ts";
/** @deprecated resultSelector is no longer supported, pipe to map instead */
export declare function zip<O1 extends ObservableInput<any>, R>(
  v1: O1,
...
>;
export declare function zip<O extends ObservableInput<any>>(
  array: O[],
): Observable<ObservedValueOf<O>[]>;
export declare function zip<R>(array: ObservableInput<any>[]): Observable<R>;
/** @deprecated resultSelector is no longer supported, pipe to map instead */
export declare function zip<O extends ObservableInput<any>, R>(
  array: O[],
  resultSelector: (...values: ObservedValueOf<O>[]) => R,
): Observable<R>;
/** @deprecated resultSelector is no longer supported, pipe to map instead */
export declare function zip<R>(
