...
/** @deprecated remove in v8. Use {@link scheduled} instead `scheduled([a, b, c], scheduler)` */
export declare function of<T, T2>(
  a: T,
  b: T2,
  scheduler: SchedulerLike,
): Observable<T | T2>;
/** @deprecated remove in v8. Use {@link scheduled} instead `scheduled([a, b, c], scheduler)` */
export declare function of<T, T2, T3>(
  a: T,
  b: T2,
  c: T3,
  scheduler: SchedulerLike,
...
/** @deprecated remove in v8. Use {@link scheduled} instead `scheduled([a, b, c], scheduler)` */
export declare function of<T, T2, T3, T4>(
  a: T,
  b: T2,
  c: T3,
  d: T4,
...
/** @deprecated remove in v8. Use {@link scheduled} instead `scheduled([a, b, c], scheduler)` */
export declare function of<T, T2, T3, T4, T5>(
  a: T,
  b: T2,
  c: T3,
  d: T4,
...
/** @deprecated remove in v8. Use {@link scheduled} instead `scheduled([a, b, c], scheduler)` */
export declare function of<T, T2, T3, T4, T5, T6>(
  a: T,
  b: T2,
  c: T3,
  d: T4,
...
/** @deprecated remove in v8. Use {@link scheduled} instead `scheduled([a, b, c], scheduler)` */
export declare function of<T, T2, T3, T4, T5, T6, T7>(
  a: T,
  b: T2,
  c: T3,
  d: T4,
...
/** @deprecated remove in v8. Use {@link scheduled} instead `scheduled([a, b, c], scheduler)` */
export declare function of<T, T2, T3, T4, T5, T6, T7, T8>(
  a: T,
  b: T2,
  c: T3,
  d: T4,
...
/** @deprecated remove in v8. Use {@link scheduled} instead `scheduled([a, b, c], scheduler)` */
export declare function of<T, T2, T3, T4, T5, T6, T7, T8, T9>(
  a: T,
  b: T2,
  c: T3,
  d: T4,
...
export declare function of<T, U, V>(
  value1: T,
  value2: U,
  value3: V,
): Observable<T | U | V>;
export declare function of<A extends Array<any>>(
  ...args: A
