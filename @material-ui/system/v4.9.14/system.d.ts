...
export type PropsFor<SomeStyleFunction> = SomeStyleFunction extends
  StyleFunction<infer Props> ? Props
  : never;
...
export function breakpoints<
  Props,
  Breakpoints extends string = DefaultBreakPoints,
>(
...
export type ComposedStyleFunction<T extends Array<StyleFunction<any>>> =
  ...
  >;
export function compose<T extends Array<StyleFunction<any>>>(
  ...args: T
